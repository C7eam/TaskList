...
namespace TaskList.Application.Authentification.Commands
{
    ...
    public class AuthCommandHandler : IRequestHandler<AuthCommand, AuthResponseDTO>
    {
        ...
        {
            var passData = request.Password;
            SHA512 shaM = new SHA512Managed();
            var hashPass = shaM.ComputeHash(passData);
            var user = await _applicationContext.Users.FirstAsync(u => u.Login == request.Login && u.Password == hashPass, cancellationToken);
